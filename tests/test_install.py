...
def test_cli_execution():
    ...
    This test assumes that the 'gpt-computer' command is available and operational after installation.
    """
    # Run the 'gpt-computer' command with the '--help' option and capture its output.
    result = subprocess.run(
        args=["gpt-computer", "--help"], capture_output=True, text=True
    )
