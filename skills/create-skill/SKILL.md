---
name: "create-skill"
description: "Wizard for creating new GPT Computer skills. Guides users through creating well-structured SKILL.md files. Use when users want to create custom skills."
version: "1.0.0"
author: "GPT Computer Team"
...
This skill helps you create new GPT Computer skills that follow the SKILL.md standard.
