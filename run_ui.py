...
from gpt_computer.helpers.api import ApiHandler
from gpt_computer.helpers.extract_tools import load_classes_from_folder
from gpt_computer.helpers.files import get_abs_path
from gpt_computer.helpers.print_style import PrintStyle
from gpt_computer.helpers.websocket import WebSocketHandler, validate_ws_origin
from gpt_computer.helpers.websocket_manager import WebSocketManager
from gpt_computer.helpers.websocket_namespace_discovery import (
...
def _build_websocket_handlers_by_namespace(
    ...
    discoveries = discover_websocket_namespaces(
        handlers_folder="gpt_computer/websocket_handlers",
...
def run():
    ...
    handlers = load_classes_from_folder("gpt_computer/api", "*.py", ApiHandler)
