# gpt_computer/tools/code_execution_tool.py
...
from gpt_computer.helpers import files, projects, rfc_exchange, runtime
from gpt_computer.helpers.messages import truncate_text as truncate_text_agent
from gpt_computer.helpers.print_style import PrintStyle
from gpt_computer.helpers.shell_local import LocalInteractiveSession
from gpt_computer.helpers.shell_ssh import SSHInteractiveSession
from gpt_computer.helpers.strings import truncate_text as truncate_text_string
...
class CodeExecution(Tool):
    ...
    def get_cwd(self):
        ...
        normalized = files.normalize_gptc_path(project_path)
        return normalized
