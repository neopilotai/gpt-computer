...
from gpt_computer.helpers import dotenv, login, runtime
from gpt_computer.helpers.api import ApiHandler, Input, Output, Request, session
...
class GetCsrfToken(ApiHandler):
    ...
    async def get_allowed_origins(self) -> list[str]:
        ...
        try:
            from gpt_computer.api.tunnel_proxy import process as tunnel_api_process
