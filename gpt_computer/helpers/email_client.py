...
from gpt_computer.helpers.errors import RepairableException, format_error
...
class EmailClient:
    ...
    async def _save_attachment_bytes(
        ...
        Uses GPT Computer's file helpers for path management.
        """
        # Sanitize filename
...
async def read_messages(
    ...
    Example:
        from gpt_computer.helpers.email_client import read_messages
