...
from gpt_computer.helpers import dirty_json, file_tree, files, persist_chat
...
def _normalize_subagents(
    ...
    from gpt_computer.helpers import subagents
...
def load_project_secrets_masked(name: str, merge_with_global=False):
    from gpt_computer.helpers import secrets
...
def save_project_secrets(name: str, secrets: str):
    from gpt_computer.helpers.secrets import get_project_secrets_manager
