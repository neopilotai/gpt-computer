...
from gpt_computer.helpers import dotenv, files, rfc, settings
...
def get_persistent_id() -> str:
    id = dotenv.get_dotenv_value("GPTC_PERSISTENT_RUNTIME_ID")
    if not id:
        id = secrets.token_hex(16)
        dotenv.save_dotenv_value("GPTC_PERSISTENT_RUNTIME_ID", id)
    return id
