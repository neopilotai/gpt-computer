...
def load_plugin_variables(
    ...
    if plugin_file and exists(plugin_file):
        ...
        from gpt_computer.helpers import extract_tools
...
from gpt_computer.helpers.strings import sanitize_string
...
def fix_dev_path(path: str):
    ...
    from gpt_computer.helpers.runtime import is_development
...
def normalize_gptc_path(path: str):
