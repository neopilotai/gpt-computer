...
from gpt_computer.helpers import files, git, runtime
...
class BackupService:
    ...
    def __init__(self):
        ...
        self.base_paths = {
            self.gpt_computer_root: self.gpt_computer_root,
        }
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"gpt-computer-backup-{timestamp[:10]}",
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes GPT Computer project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up GPT Computer root path with the current GPT Computer root path
        ...
        Args:
            ...
            backup_metadata: Backup metadata containing the original gpt_computer_root

        Returns:
            List of translated patterns for the current system
        """
        # Get the backed up gpt computer root path from metadata
        environment_info = backup_metadata.get("environment_info", {})
        backed_up_agent_root = environment_info.get("gpt_computer_root", "")

        # Get current gpt computer root path
        current_agent_root = self.gpt_computer_root
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up gpt computer root
    ...
    async def create_backup(
        ...
        backup_name: str = "gpt-computer-backup"
    ) -> str:
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up gpt computer root
