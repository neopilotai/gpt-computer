...
class Memory:
    ...
    def _preload_knowledge_folders(
        ...
        #
        # try:
        #     from gpt_computer.systems.skills.importer import get_project_skills_folder
        #     from gpt_computer.helpers import projects as projects_helper
...
def get_context_memory_subdir(context: AgentContext) -> str:
    # if project is active, use project memory subdir
    from gpt_computer.helpers.projects import (
