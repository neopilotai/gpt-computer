...
from gpt_computer.systems.skills.manager import discover_skill_md_files
...
def _unzip_to_temp_dir(zip_path: Path) -> Path:
    """
    Extract a zip into a temp folder under tmp/skill_imports (inside GPT Computer base dir).
...
def get_project_skills_folder(project_name: str) -> Path:
    ...
    from gpt_computer.helpers.projects import get_project_meta_folder
