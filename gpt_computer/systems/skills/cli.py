#!/usr/bin/env python3
"""
Skills CLI - Easy skill management for GPT Computer

Usage:
    python -m gpt_computer.systems.skills.cli list              List all skills
    python -m gpt_computer.systems.skills.cli create <name>     Create a new skill
    python -m gpt_computer.systems.skills.cli show <name>       Show skill details
    python -m gpt_computer.systems.skills.cli validate <name>   Validate a skill
    python -m gpt_computer.systems.skills.cli search <query>    Search skills
"""
...
from gpt_computer.helpers import files
...
def main():
    parser = argparse.ArgumentParser(
        description="GPT Computer Skills CLI",
  ...
  %(prog)s search python            Search for skills
    ...
    if args.command == "list":
        ...
        try:
            ...
            print(f"  3. Run: python -m gpt_computer.systems.skills.cli validate {args.name}")
