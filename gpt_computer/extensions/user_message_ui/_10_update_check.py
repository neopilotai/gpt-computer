...
from gpt_computer.helpers import notification, settings, update_check
from gpt_computer.helpers.extension import Extension

# check for newer versions of GPTC available and send notification
...
class UpdateCheck(Extension):
    ...
    def send_notification(self, notif):
        ...
        notifs.send_notification(
            ...
            message=notif.get("message", "A newer version of GPT Computer is available. Please update to the latest version."),
