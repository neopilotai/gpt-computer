...
from gpt_computer.extensions.message_loop_prompts_after._50_recall_memories import (
    DATA_NAME_ITER as DATA_NAME_ITER_MEMORIES,
    DATA_NAME_TASK as DATA_NAME_TASK_MEMORIES,
)

# from gpt_computer.extensions.message_loop_prompts_after._51_recall_solutions import DATA_NAME_TASK as DATA_NAME_TASK_SOLUTIONS
