...
from gpt_computer.helpers import errors, settings
from gpt_computer.helpers.defer import THREAD_BACKGROUND, DeferredTask
            ...
            for memory in memories:
                ...
                if set["memory_memorize_consolidation"]:
                    ...
                    try:
                        ...
                        from gpt_computer.systems.memory.consolidation import (
