...
def initialize_agent(override_settings: dict | None = None):
    ...
    # import gpt_computer.systems.mcp.handler as mcp_helper
    # import agent as agent_helper
    # import gpt_computer.helpers.print_style as print_style_helper
...
def initialize_mcp():
    ...
    async def initialize_mcp_async():
        from gpt_computer.systems.mcp.handler import initialize_mcp as _initialize_mcp
        return _initialize_mcp(set["mcp_servers"])
    return defer.DeferredTask().start_task(initialize_mcp_async)

def initialize_job_loop():
    from gpt_computer.helpers.job_loop import run_loop
